...
def controls():
    while True:
        try:
            publish.single("controller/LeftJoystickX", str(joyROV.LeftJoystickY) + " " + 
                str(joyROV.LeftJoystickX) + " " + str((joyROV.RightTrigger - joyROV.LeftTrigger) / 4.0) + " " + 
                str((joyROV.RightBumper - joyROV.LeftBumper)) + " " + str(joyROV.RightJoystickY) + " " + 
                str(joyROV.RightJoystickX) + " " + str(round(pow(joyClaw.RightJoystickX, 3), 1)) + " " + 
                str(round(pow(joyClaw.LeftJoystickX, 3), 1)), hostname="192.168.8.117") 
        except:
            pass
